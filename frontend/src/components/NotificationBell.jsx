...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-11 w-80 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 overflow-hidden animate-fade-in">
          {/* Header */}
                ...
                >
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 w-5 h-5 rounded text-gray-300 hover:text-red-400 transition-all text-xs"
                    >
                      ✕
                    </button>
                  </div>
