      ...
      <Modal isOpen={formModal} onClose={() => setFormModal(false)} title={editUser ? 'Edit User' : 'Tambah User'} size="md">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 justify-end pt-2 border-t border-gray-100">
            <button type="button" onClick={() => setFormModal(false)} className="btn-ghost">Batal</button>
            <button type="submit" disabled={submitting} className="btn-primary" id="btn-submit-user">
